...
- The counter starts with an initial value of **20**.
- Clicking **Increment** increases the counter by **1**.
- Clicking **Decrement** decreases the counter by **1**, but it never goes below **0**.
- Clicking **Reset** restores the counter to its initial value (**20**).
